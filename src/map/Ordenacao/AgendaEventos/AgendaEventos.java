...
public class AgendaEventos {
    ...
    public void exibirAgenda(){
        Map<LocalDate, Evento> agendaOrdenadoPorData = new TreeMap<LocalDate, Evento>(agendaEventosMap);
        System.out.println(agendaOrdenadoPorData);
    }
    public void obterProximoEvento(){
        ...
        Map<LocalDate, Evento> agendaOrdenadoPorData = new TreeMap<LocalDate, Evento>(agendaEventosMap);
        for (Map.Entry<LocalDate, Evento> entry: agendaOrdenadoPorData.entrySet()) {
